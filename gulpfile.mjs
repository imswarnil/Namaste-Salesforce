...
/* Both catch failures that RENDER — an undefined class renders as bare
   markup, a missing icon partial renders as nothing — which is why neither
   gscan nor a green build sees them. */
