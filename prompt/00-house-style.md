...
| **Monospace is structural** | Every index (`01`), duration, timestamp, status and kicker is set in Fira Code *by the theme*. Never type a fake kicker like `// Getting started` into the body. |
